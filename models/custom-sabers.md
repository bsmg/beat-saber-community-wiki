...
# Installation
The latest Custom Saber plugin can be found in the [Installer](/beginners-guide#how-to-install-mods). Run the ModSaber Installer, select the Custom Saber plugin, and click Install.
