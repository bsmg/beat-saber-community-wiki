...
* Low framerate can also be caused by something going wrong at: `%AppData%\..\LocalLow\Hyperbolic Magnetism` You can fix this by either renaming or deleting the folder.
